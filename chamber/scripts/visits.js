if (typeof(Storage) !== "undefined") {
    ...
    if (!lastVisit) {
      document.getElementById("message").textContent = "Welcome to Portoviejo chamber of commerce! Here you can find useful information about our products and community.";
    } else {
